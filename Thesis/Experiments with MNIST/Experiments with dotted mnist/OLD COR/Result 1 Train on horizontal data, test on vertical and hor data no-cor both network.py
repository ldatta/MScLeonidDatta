...
a=np.load('/Users/leoniddatta/Dropbox/TU Delft/Study material/DL THESIS/Experiments with MNIST/horTrainData.npy')  #HORIZONTAL training data 60000*28*28*1
...
# def cor(img):
#     #sum1=np.zeros((img.shape[0],28,28))
#     cor1=np.zeros((img.shape[0],img.shape[1],img.shape[2]))
#     for i in range (img.shape[0]):
#         #print("image shape",img.shape,img.shape[0])
