...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(3, 3, kernel_size=5,stride=1, padding=0,groups = 3)
        self.conv11 = nn.Conv2d(3, 32, kernel_size=1,stride=1, padding=0,groups = 1)
        self.conv2 = nn.Conv2d(32, 32, kernel_size=5,stride=1, padding=0,groups = 32)
        self.conv22 = nn.Conv2d(32, 64, kernel_size=1, stride=1, padding=0, groups = 1)
        self.conv3 = nn.Conv2d(64, 64, kernel_size=3, stride=1, padding=0,groups = 64)
        self.conv33 = nn.Conv2d(64, 10, kernel_size=1, stride=1, padding=0,groups = 1)
# =============================================================================
