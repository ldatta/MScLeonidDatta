...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(25, 18, 3, 1)
        self.conv3 = nn.Conv2d(18, 10, 5, 1)
    ...
    def forward(self, x):
        ...
        #print(x.shape,"maxpl 1")
        x = F.relu(self.conv2(x))
        #print(x.shape,"conv2+relu")
        x = F.max_pool2d(x, 2, 2)
        #print(x.shape,"maxpl 2 ")
        x = F.relu(self.conv3(x))
        #print(x.shape,"conv3 + relu")
        #x = F.relu(self.conv4(x))
        x = x.view(-1, 10) 
        #print(x.shape,"before soft")
