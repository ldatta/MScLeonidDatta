...
def cor(img):
    ...
    for i in range (img.shape[0]):
        ...
        cor1[i,5,:,:]=C.correlate(img[i,1,:,:],img[i,1,:,:], output=None, mode='constant', cval=0.0, origin=0)
...
# =============================================================================
# def cor(img):
#     cor1=np.zeros((28,28,6))
#     cor1[:,:,0]=C.correlate(img[:,:,0],img[:,:,0], output=None, mode='constant', cval=0.0, origin=0)
#     cor1[:,:,1]=C.correlate(img[:,:,1],img[:,:,1], output=None, mode='constant', cval=0.0, origin=0)
#     cor1[:,:,2]=C.correlate(img[:,:,2],img[:,:,2], output=None, mode='constant', cval=0.0, origin=0)
#     cor1[:,:,3]=C.correlate(img[:,:,3],img[:,:,3], output=None, mode='constant', cval=0.0, origin=0)
#     cor1[:,:,4]=C.correlate(img[:,:,4],img[:,:,4], output=None, mode='constant', cval=0.0, origin=0)
#     cor1[:,:,5]=C.correlate(img[:,:,5],img[:,:,5], output=None, mode='constant', cval=0.0, origin=0)
#     sum1=cor1[:,:,0]+cor1[:,:,1]+cor1[:,:,2]+cor1[:,:,3]+cor1[:,:,4]+cor1[:,:,5]
#     return sum1
# =============================================================================
# =============================================================================
# Network: 
