...
a=a*mask3   #mask 2 is square #mask is horizontal
b=b*mask4
c=c*mask3
...
N=1
title='Accuracy Graph: trained on horizontal data' 
class Net(nn.Module):
    def __init__(self):
...
def train(args, model, device, train_loader, optimizer, epoch):
    ...
    return [r,g,t,train_accuracy,weight1,weight2,weight3]
...
for epoch in range(1, args.epochs + 1):    
    [r,g,t,ta,weight1,weight2,weight3]=train(args, model, device, train_loader, optimizer, epoch)
    redaccm[epoch-1]=r
    grnaccm[epoch-1]=g
    trnaccm[epoch-1]=t
