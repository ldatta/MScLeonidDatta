...
a=np.load('/Users/leoniddatta/Dropbox/TU Delft/Study material/DL THESIS/train.npy')  #HORIZONTAL training data 60000*28*28*1
a2=np.load('/Users/leoniddatta/Dropbox/TU Delft/Study material/DL THESIS/trainlabel.npy')
b=np.load('/Users/leoniddatta/Dropbox/TU Delft/Study material/DL THESIS/test.npy')   #VERTICAL test data 10000*28*28*1
b2=np.load('/Users/leoniddatta/Dropbox/TU Delft/Study material/DL THESIS/testlabel.npy') 
c=np.load('/Users/leoniddatta/Dropbox/TU Delft/Study material/DL THESIS/test.npy')  #HORIZONTAL test data
c2=np.load('/Users/leoniddatta/Dropbox/TU Delft/Study material/DL THESIS/testlabel.npy')
a=a[:,:,:,0]
b=b[:,:,:,1]
c=c[:,:,:,1]
