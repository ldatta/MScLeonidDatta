...
#     model = Netconv().to(device)
    ...
    np.save('notunR7trainRGBK21K4maskgap5red.npy',resultred)
    np.save('notunR7trainRGBK21K4maskgap5grn.npy',resultgrn)
    np.save('notunR7trainRGBK21K4maskgap5trn.npy',resulttrn)
