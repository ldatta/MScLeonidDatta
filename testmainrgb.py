...
#     model = Netconv().to(device)
    ...
    np.save('notunR7trainRGBK21K12maskgap5red.npy',resultred)
    np.save('notunR7trainRGBK21K12maskgap5grn.npy',resultgrn)
    np.save('notunR7trainRGBK21K12maskgap5trn.npy',resulttrn)
