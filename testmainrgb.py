...
#     model = Netconv().to(device)
    ...
    np.save('GLtrainRGBWorkingK21maskgap1red.npy',resultred)
    np.save('GLtrainRGBWorkingK21maskgap1grn.npy',resultgrn)
    np.save('GLtrainRGBWorkingK21maskgap1trn.npy',resulttrn)
