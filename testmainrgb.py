...
#     model = Netconv().to(device)
    ...
    np.save('R7trainRGBK216K64maskgap5red.npy',resultred)
    np.save('R7trainRGBK216K64maskgap5grn.npy',resultgrn)
    np.save('R7trainRGBK216K64maskgap5trn.npy',resulttrn)
