...
#     model = Netconv().to(device)
    ...
    np.save('notunGLtrainRGBK24K4maskgap5red.npy',resultred)
    np.save('notunGLtrainRGBK24K4maskgap5grn.npy',resultgrn)
    np.save('notunGLtrainRGBK24K4maskgap5trn.npy',resulttrn)
