...
#     model = Netconv().to(device)
    ...
    np.save('R7trainRGBK216K128maskgap5red.npy',resultred)
    np.save('R7trainRGBK216K128maskgap5grn.npy',resultgrn)
    np.save('R7trainRGBK216K128maskgap5trn.npy',resulttrn)
