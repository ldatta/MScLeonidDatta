...
#     model = Netconv().to(device)
    ...
    np.save('notunGLtrainRGBK21K12maskgap5red.npy',resultred)
    np.save('notunGLtrainRGBK21K12maskgap5grn.npy',resultgrn)
    np.save('notunGLtrainRGBK21K12maskgap5trn.npy',resulttrn)
