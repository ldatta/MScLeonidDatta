...
#     model = Netconv().to(device)
    ...
    np.save('notunGLtrainRGBK21K16maskgap5red.npy',resultred)
    np.save('notunGLtrainRGBK21K16maskgap5grn.npy',resultgrn)
    np.save('notunGLtrainRGBK21K16maskgap5trn.npy',resulttrn)
