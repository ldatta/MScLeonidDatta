...
#     model = Netconv().to(device)
    ...
    np.save('notunR7trainRGBK22K2maskgap5red.npy',resultred)
    np.save('notunR7trainRGBK22K2maskgap5grn.npy',resultgrn)
    np.save('notunR7trainRGBK22K2maskgap5trn.npy',resulttrn)
