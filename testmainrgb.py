...
#     model = Netconv().to(device)
    ...
    np.save('notunR7trainRGBK21K8maskgap5red.npy',resultred)
    np.save('notunR7trainRGBK21K8maskgap5grn.npy',resultgrn)
    np.save('notunR7trainRGBK21K8maskgap5trn.npy',resulttrn)
