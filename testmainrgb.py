...
#     model = Netconv().to(device)
    ...
    np.save('notunGLtrainRGBK21K8maskgap5red.npy',resultred)
    np.save('notunGLtrainRGBK21K8maskgap5grn.npy',resultgrn)
    np.save('notunGLtrainRGBK21K8maskgap5trn.npy',resulttrn)
