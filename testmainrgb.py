...
#     model = Netconv().to(device)
    ...
    np.save('notunR7trainRGBK21K16maskgap5red.npy',resultred)
    np.save('notunR7trainRGBK21K16maskgap5grn.npy',resultgrn)
    np.save('notunR7trainRGBK21K16maskgap5trn.npy',resulttrn)
