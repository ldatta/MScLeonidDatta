...
for seed_no in range(10):
    ...
    np.save('GLtrainedalwaysKeepBetterR7seed{seed}Itr5tune_size500tunelist'.format(seed=seed_no+1),listtune)
    np.save('GLtrainedalwaysKeepBetterR7seed{seed}Itr5tune_size500testlist'.format(seed=seed_no+1),listtest)
