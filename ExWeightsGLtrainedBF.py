...
for seed_no in range(10):
    ...
    np.save('GLtrainedalwaysKeepBetterR7seed{seed}Itr5tune_size50tunelist'.format(seed=seed_no+1),listtune)
    np.save('GLtrainedalwaysKeepBetterR7seed{seed}Itr5tune_size50testlist'.format(seed=seed_no+1),listtest)


print("First 100 of listtune",listtune[:100])
print("First 100 of listtest",listtest[:100])
print(finallist)
print("GL trained!Tune Size 50, KeepBetter, Iteration 5")
