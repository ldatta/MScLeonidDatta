...
#         self.x3=torch.nn.Parameter(weightittensor(1,64*k,3,1)) #first random tensor generated for layer 3
#         self.x4=torch.nn.Parameter(weightittensor(1,128*k,3,1)) #first random tensor generated for layer 4
#         self.x5=torch.nn.Parameter(weightittensor(1,10,3,1)) #first random tensor generated for layer 5
# =============================================================================
...
# =============================================================================
        ...
        new_shape1 = [16*k,1,3,3]
        new_shape2 = [32*k,1,3,3]
        new_shape3 = [64*k,1,3,3]
        new_shape4 = [128*k,1,3,3]
        new_shape5 = [10,1,3,3]
...
#             x1_weights[:,i,:,:] = torch.nn.Parameter(weightittensor(3*k,16*k,3,1))#self.x1
