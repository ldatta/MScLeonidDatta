...
for seed_no in range(10):
    ...
    np.save('R7trainedalwaysKeepBetterGLseed{seed}Itr5tune_size50tunelist'.format(seed=seed_no+1),listtune)
    np.save('R7trainedalwaysKeepBetterGLseed{seed}Itr5tune_size50testlist'.format(seed=seed_no+1),listtest)
...
print(finallist)
print("R7 trained! Tune Size 50, KeepBetter, Iteration 5")
