...
for seed_no in range(10):
    ...
    np.save('R7trainedKeepBestOfLayerGLseed{seed}Itr5tune_size500tunelist'.format(seed=seed_no+1),listtune)
    np.save('R7trainedKeepBestOfLayerGLseed{seed}Itr5tune_size500testlist'.format(seed=seed_no+1),listtest)
    

print("First 200 of listtune",listtune[:200])
print("First 200 of listtest",listtest[:200])
#print(finallist)
print("R7 trained! Tune Size 500, Keep the best of layers , Iteration 5")
